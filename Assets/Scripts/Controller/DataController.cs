...
public class DataController
{
	...
	{
		if (PlayerPrefs.HasKey(TAG_INAPP))
		{
			return PlayerPrefs.GetInt(TAG_INAPP);
		}
		else
		{
			return 0;
	...
	public static void SaveInApp(int newHightScore)
	{
		PlayerPrefs.SetInt(TAG_INAPP, newHightScore);
	}
	//---------------------in
